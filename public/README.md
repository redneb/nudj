...
*   **`src/web/assets/logo.svg`**: The "Smart" variant used by the PWA. Uses `currentColor` for the main shape, automatically adapting to the parent's text color. Located in the web source directory for proper bundling. **Contains animation.**
